...
const VLLM_AGENT_COUNT_ENV: &str = "MADE_VLLM_AGENT_COUNT";
const VLLM_MAX_TOKENS_ENV: &str = "MADE_VLLM_MAX_TOKENS";
const VLLM_TIMEOUT_SECS_ENV: &str = "MADE_VLLM_TIMEOUT_SECS";
const RUN_ID_ENV: &str = "MADE_E2E_RUN_ID";

/// Full MADE E2E against a real vLLM provider.
///
...
fn summarize_candidate_reports(candidates: &[made_proto::v1::CandidateSummary]) -> String {
    candidates
        .iter()
        .map(|candidate| {
