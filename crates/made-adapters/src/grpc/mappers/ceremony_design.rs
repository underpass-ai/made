...
use made_app::usecases::{
    ...
    CeremonyDesignOutputFieldGuard, CeremonyDesignParticipant,
...
use super::ceremony_design_stage::stage_entry_from_proto;
...
pub(super) fn exit_guard_from_proto(
...
#[cfg(test)]
mod tests {
    use made_app::usecases::{CeremonyDesignJoin, CeremonyDesignStageEntry};
    use made_core::value_objects::{StateExecution, StateIteration};
