...
use made_app::usecases::{DeliberateOutput, OrchestrateOutput};
...
pub fn deliberate_response_from(out: &DeliberateOutput) -> pb::DeliberateResponse {
    ...
    let duration_ms = out
        .deliberation
        .duration()
        .map_or(0, made_core::value_objects::DurationMs::get);
...
fn flatten_ranked(deliberation: &made_core::entities::Deliberation) -> Vec<pb::DeliberationResult> {
