...
use made_core::value_objects::{
    ...
    CeremonyLineage, CeremonyParticipantBinding, CeremonyReason, CeremonyRecordRef,
...
fn lineage_state_from(lineage: &CeremonyLineage) -> pb::CeremonyLineageState {
...
fn child_group_state_from(group: &ChildGroupState) -> pb::CeremonyChildGroupState {
    let plan = group.plan();
