...
mod tests {
    ...
    impl MetricsRecorderPort for CapturingMetrics {
        fn observe_deliberation_duration(
            &self,
            _s: &Specialty,
            _d: made_core::value_objects::DurationMs,
        ) {
        }
        fn record_deliberation_outcome(
            &self,
            _s: &Specialty,
            _o: made_core::value_objects::DeliberationOutcome,
        ) {
        }
        fn observe_winner_score(&self, _s: &Specialty, _sc: made_core::value_objects::Score) {}
        fn observe_judge_latency(&self, _m: &str, _d: made_core::value_objects::DurationMs) {}
        fn observe_judge_score(&self, _m: &str, _sc: made_core::value_objects::Score) {}
        ...
        fn record_discrimination(
            ...
            _result: made_core::value_objects::Discrimination,
        ) {
        }
