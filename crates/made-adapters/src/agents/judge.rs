...
use made_core::ports::{MetricsRecorderPort, ValidatorPort};
use made_core::value_objects::{Attributes, DurationMs, LlmErrorKind, Score, TokenUsage};
use reqwest::Client;
...
mod tests {
    ...
    impl MetricsRecorderPort for CapturingMetrics {
        fn observe_deliberation_duration(
            &self,
            _specialty: &made_core::value_objects::Specialty,
        ...
        fn record_deliberation_outcome(
            &self,
            _specialty: &made_core::value_objects::Specialty,
            _outcome: made_core::value_objects::DeliberationOutcome,
        ) {
        }
