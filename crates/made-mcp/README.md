...
| `made_design_ceremony`          | `DesignCeremony`                  | turn explicit stages or the `roundtable_fixed_order` preset, plus optional positive transition budgets, into an analysed unpublished draft |
