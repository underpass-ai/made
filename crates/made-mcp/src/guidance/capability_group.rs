use crate::protocol::{
    ABORT_ARTIFACT_UPLOAD_TOOL, ACCEPT_CHILD_COMPLETION_TOOL, ADOPT_EXECUTION_RECEIPT_TOOL,
    ...
    LIST_AGENTIC_SYSTEMS_TOOL, LIST_ARTIFACTS_TOOL, LIST_CEREMONY_INSTANCES_TOOL,
    LIST_PENDING_BUDGET_RESERVATIONS_TOOL, PAUSE_CEREMONY_TOOL, PREPARE_CEREMONY_CHILDREN_TOOL,
    PUBLISH_AGENTIC_SYSTEM_TOOL, PUBLISH_CEREMONY_DEFINITION_TOOL, PULL_CEREMONY_EVENTS_TOOL,
    PUT_ARTIFACT_CHUNK_TOOL, READ_ARTIFACT_CHUNK_TOOL, READ_CEREMONY_EVENTS_TOOL,
    RECOVER_CEREMONY_CHILDREN_TOOL, RENDER_AGENTIC_SYSTEM_DIAGRAM_TOOL,
    ...
    STREAM_CEREMONY_TOOL, TOMBSTONE_ARTIFACT_TOOL, VALIDATE_AGENTIC_SYSTEM_TOOL,
