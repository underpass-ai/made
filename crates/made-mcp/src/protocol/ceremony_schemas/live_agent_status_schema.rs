        ...
        "properties": {
            "status": {
                ...
                "properties": {
                    ...
                    "activity": string_schema("Bounded activity label; no chain-of-thought."), "blocker": string_schema("Bounded blocker label."), "dependency": string_schema("Bounded dependency identity."), "task_summary": string_schema("Bounded task summary; no credentials or private chain-of-thought."),
