...
use choreo_core::ports::{ContractRegistryPort, CouncilRegistryPort, DeliberationRepositoryPort};
...
// `Deliberation::ranked_outcomes` (see `crates/choreo-core/src/entities/deliberation.rs`).
...
mod tests {
    ...
    // `crates/choreo-tests-integration/tests/run_council_decision_rpc.rs`).
