...
//! depends only on traits from [`made_core::ports`]. No vLLM,
...
impl DeliberateUseCase {
    ...
    async fn finalize(
        ...
        ranked: Vec<made_core::entities::RankedOutcome>,
        task: &Task,
...
mod tests {
    ...
    impl ScoringPort for RerankingScoring {
        ...
        fn discrimination(
            &self,
            _ranked: &[made_core::entities::RankedOutcome],
        ) -> Option<made_core::value_objects::Discrimination> {
            Some(made_core::value_objects::Discrimination::Reranked)
        }
    }
    ...
    struct NullStats;
    #[async_trait]
    impl made_core::ports::StatisticsPort for NullStats {
        async fn record_deliberation(
            &self,
            _specialty: &Specialty,
            _duration: made_core::value_objects::DurationMs,
        ) -> Result<(), DomainError> {
            Ok(())
        }
        ...
        async fn snapshot(&self) -> Result<made_core::entities::Statistics, DomainError> {
            Ok(made_core::entities::Statistics::default())
        }
    }
    ...
    use made_core::value_objects::{DeliberationOutcome, Discrimination, DurationMs};
    ...
    impl MetricsRecorderPort for RecordingMetrics {
        ...
        fn record_judge_error(&self, _model: &str, _kind: made_core::value_objects::LlmErrorKind) {}
        fn record_provider_error(
            &self,
            _provider: &str,
            _kind: made_core::value_objects::LlmErrorKind,
        ) {
        }
        fn record_judge_tokens(&self, _model: &str, _usage: made_core::value_objects::TokenUsage) {}
        fn record_provider_tokens(
            &self,
            _provider: &str,
            _usage: made_core::value_objects::TokenUsage,
        ) {
        }
        ...
        fn record_ceremony_outcome(
            &self,
            _ceremony: &str,
            _outcome: made_core::value_objects::CeremonyOutcome,
        ) {
        }
        ...
        fn record_ceremony_step(
            ...
            _ceremony: &str,
            _step: &str,
            _status: made_core::value_objects::StepStatus,
        ) {
        }
        ...
        fn record_scoring_mode(&self, _mode: made_core::value_objects::ScoringMode) {}
    }
    ...
    fn build_usecase(
        ...
        let stats: Arc<dyn made_core::ports::StatisticsPort> = Arc::new(NullStats);
    ...
    #[async_trait]
    impl made_core::ports::DeliberationObserverPort for RecordingObserver {
