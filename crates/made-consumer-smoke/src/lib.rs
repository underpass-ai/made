//! Generic consumer-smoke harness for MADE's public
//! surface (Epic 12).
//!
//! Three chains live here. They drive MADE through its
...
//!
//! The crate is also a thin binary (`bin/made-consumer-smoke`)
