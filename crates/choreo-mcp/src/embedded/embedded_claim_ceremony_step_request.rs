use choreo_app::usecases::StartCeremonyStepInput;
...
impl TryFrom<&Value> for EmbeddedClaimCeremonyStepRequest {
    type Error = String;
    ...
    fn try_from(value: &Value) -> Result<Self, Self::Error> {
        ...
        let idempotency_key = optional_string(object, "idempotency_key")?
            .unwrap_or_else(|| format!("choreo-mcp-external-{}", Uuid::new_v4()));
