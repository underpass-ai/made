...
//!
//! Controlled by `MADE_SEED_SPECIALTIES`: a comma-separated list
...
pub const SEED_ENV_VAR: &str = "MADE_SEED_SPECIALTIES";
...
pub const CONTRACT_DIR_ENV_VAR: &str = "MADE_CONTRACT_DIR";
...
/// Read `MADE_CONTRACT_DIR` and register every `*.json` contract it
...
mod tests {
    ...
    use made_core::ports::{AgentResolverPort, CouncilRegistryPort};
