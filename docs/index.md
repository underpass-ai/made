...
[Support matrix](operations/support-matrix.md) names the supported surfaces.
[Documentation catalogue](documentation-catalog.md) distinguishes active
guidance, executable contracts and the historical snapshot. Old plans are
not evidence that a feature is available.
